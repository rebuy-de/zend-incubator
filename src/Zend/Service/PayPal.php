...
class Zend_Service_PayPal
{
	 ...
	 */
	public function __construct(Zend_Service_PayPal_Data_AuthInfo $authInfo, $uri, $httpClient = null)
	{
	 ...
	 * @return Zend_Service_PayPal_Response
	 */
	public function doExpressCheckoutPayment($token, $payerId, $amount, $params = array())
	{
